...
public class RelojesFragment extends Fragment {
    ...
    EditText idEdit, modeloEdit, marcaEdit, descrEdit, precioEdit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        idEdit = v.findViewById(R.id.idEdit);
        ...
        anadirButton = v.findViewById(R.id.btnBotonCreado);
        ...
        anadirButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double pre = Double.parseDouble(precioEdit.getText().toString().trim());
