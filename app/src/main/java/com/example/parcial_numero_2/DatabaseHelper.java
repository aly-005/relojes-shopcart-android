...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertValues(String modelo, String marca, String descr, double precio){
    ...
    public List<ClaseReloj> getAll() {
        List<ClaseReloj> items = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            //-----------------------0=ID, 1=MODELO, 2=MARCA, 3=DESCRIPCION, 4=PRECIO
            ...
            items.add(new ClaseReloj(id, modelo, marca, descr, precio));
        }
    ...
    public double calcularTotalCarrito() {
        ...
        Cursor cursor = db.rawQuery("SELECT SUM(CAST(" + COL_5 + " AS REAL)) FROM " + TABLE_NAME, null);
    ...
    // DatabaseHelper.java
    public boolean addToShoppingList(String modelo, String marca, String descr, double precio) {
        return insertValues(modelo, marca, descr, precio);
    }
